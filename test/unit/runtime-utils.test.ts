...
test("shared activity tracking accumulates tools, text, and usage", () => {
  ...
  assert.deepEqual(target.activity, { turns: 1, toolUses: 1, responseText: "working", activeTools: [], usage: { input: 2, output: 3, cacheRead: 0, cacheWrite: 0, cost: 0.5, costInput: 0, costOutput: 0, costCacheRead: 0, costCacheWrite: 0, turns: 1 } });
});
